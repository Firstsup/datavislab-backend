...
module.exports = (req, res) => {
    ...
    const privateBucketDomain = 'http://r6004thqe.hn-bkt.clouddn.com';
    const deadline = parseInt(Date.now() / 1000) + 3600; // 1小时过期
    const privateDownloadUrl = bucketManager.privateDownloadUrl(privateBucketDomain, data.file, deadline);
